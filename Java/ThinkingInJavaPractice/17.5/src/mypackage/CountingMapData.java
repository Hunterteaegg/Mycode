...
import mypackage.CountingMapData.EntrySet;
...
extends AbstractMap<Integer,String> {
  ...
  {
	  Set<Map.Entry<Integer, String>> entrySet=new EntrySet<Map.Entry<Integer, String>>();
	  
	  return entrySet;
  }
  public class EntrySet<T> extends AbstractSet<Map.Entry<Integer, String>>
  {
