...
import mypackage.Mail.GeneralDelivery;
...
public class PostOffice {
  enum MailHandler {
    GENERAL_DELIVERY {
    	EnumMap<Mail.GeneralDelivery, Boolean> generalDelivery=new EnumMap<GeneralDelivery, Boolean>(Mail.GeneralDelivery.class);
    	generalDelivery.put(YES,true);
